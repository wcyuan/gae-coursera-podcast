...
def parseArgs():
    ...
    parser.add_option('--skip-download',
                        dest='skip_download',
                        action='store_true',
                        default=False,
    ...
    parser.add_option('--verbose-dirs',
                        dest='verbose_dirs',
                        action='store_true',
                        default=False,
    ...
    args, class_names = parser.parse_args()
